...
export class ConfigManager {
    ...
    setupValidation() {
        ...
        this.validators.set('game.enableAchievements', (value) => typeof value === 'boolean');
        this.validators.set('game.enableDailyChallenges', (value) => typeof value === 'boolean');
        this.validators.set('game.enableAccessibility', (value) => typeof value === 'boolean');
        this.validators.set('game.maxFPS', (value) => typeof value === 'number' && value > 0 && value <= 240);
        this.validators.set('game.targetFPS', (value) => typeof value === 'number' && value > 0 && value <= 240);
        this.validators.set('game.masterVolume', (value) => typeof value === 'number' && value >= 0 && value <= 1);
        this.validators.set('game.sfxVolume', (value) => typeof value === 'number' && value >= 0 && value <= 1);
        this.validators.set('game.musicVolume', (value) => typeof value === 'number' && value >= 0 && value <= 1);
        
        // Graphics settings validation
        this.validators.set('graphics.resolution', (value) => 
            typeof value === 'string' && ['auto', '720p', '1080p', '1440p', '4k'].includes(value));
        this.validators.set('graphics.quality', (value) => 
            typeof value === 'string' && ['low', 'medium', 'high', 'ultra'].includes(value));
        this.validators.set('graphics.textureQuality', (value) => 
            typeof value === 'string' && ['low', 'medium', 'high', 'ultra'].includes(value));
        
        // Accessibility settings validation
        this.validators.set('accessibility.colorblindMode', (value) => 
            typeof value === 'string' && ['none', 'protanopia', 'deuteranopia', 'tritanopia'].includes(value));
        this.validators.set('accessibility.textScaling', (value) => 
            typeof value === 'number' && value >= 0.5 && value <= 3.0);
        this.validators.set('accessibility.subtitleSize', (value) => 
            typeof value === 'string' && ['small', 'medium', 'large', 'extra-large'].includes(value));
        
        // Performance settings validation
        this.validators.set('performance.logLevel', (value) => 
            typeof value === 'string' && ['error', 'warn', 'info', 'debug', 'trace'].includes(value));
        this.validators.set('performance.maxLogHistory', (value) => 
        ...
        this.validators.set('ui.notificationDuration', (value) => 
        ...
        return {
            game: {
                ...
                properties: {
                    ...
                    masterVolume: { type: 'number', minimum: 0, maximum: 1, default: 1.0 }
                }
            },
            graphics: {
                type: 'object',
                properties: {
                    resolution: { type: 'string', enum: ['auto', '720p', '1080p', '1440p', '4k'], default: 'auto' },
                    quality: { type: 'string', enum: ['low', 'medium', 'high', 'ultra'], default: 'high' },
                    textureQuality: { type: 'string', enum: ['low', 'medium', 'high', 'ultra'], default: 'high' }
                }
            },
            accessibility: {
                type: 'object',
                properties: {
                    ...
                    textScaling: { type: 'number', minimum: 0.5, maximum: 3.0, default: 1.0 }
                }
            }
        };
    }
