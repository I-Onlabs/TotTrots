...
export class InputManager {
     ...
     */
    updateTabOrder() {
        this.accessibility.tabOrder = Array.from(this.accessibility.focusableElements)
            .sort((a, b) => {
    ...
    getKeyName(keyCode) {
        const keyNames = {
            ...
            'Digit7': '7', 'Digit8': '8', 'Digit9': '9', 'Space': 'Space',
            'Enter': 'Enter', 'Escape': 'Escape', 'Backspace': 'Backspace',
            'Tab': 'Tab', 'ShiftLeft': 'Left Shift', 'ShiftRight': 'Right Shift',
