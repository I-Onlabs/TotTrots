...
export class Logger {
    ...
    function(name, fn, context = null) {
        ...
        try {
            ...
            const duration = this.performance(name, startTime);
            this.error(`Function failed: ${name}`, { error: error.message, duration }, context);
            throw error;
        }
    }
    ...
    async functionAsync(name, fn, context = null) {
        ...
        try {
            ...
            const duration = this.performance(name, startTime);
            this.error(`Async function failed: ${name}`, { error: error.message, duration }, context);
            throw error;
        }
    }
    ...
    group(name, fn, context = null) {
        ...
        try {
            ...
            const duration = this.performance(name, startTime);
            this.error(`Group failed: ${name}`, { error: error.message, duration }, context);
            throw error;
        }
    }
    ...
    async groupAsync(name, fn, context = null) {
        ...
        try {
            ...
            const duration = this.performance(name, startTime);
            this.error(`Async group failed: ${name}`, { error: error.message, duration }, context);
            throw error;
        }
    }
