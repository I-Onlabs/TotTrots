...
describe('GameRefactored', () => {
  ...
  describe('Event-driven Communication', () => {
    it('should set up event listeners for cross-cutting features', () => {
      ...
      expect(mockEventBus.on).toHaveBeenCalledWith('player:comboChanged', expect.any(Function));
      expect(mockEventBus.on).toHaveBeenCalledWith('achievement:unlocked', expect.any(Function));
      expect(mockEventBus.on).toHaveBeenCalledWith('dailyChallenge:completed', expect.any(Function));
    });
  ...
  describe('Game State Management', () => {
    it('should start game correctly', async () => {
      ...
      expect(mockEventBus.emit).toHaveBeenCalledWith('game:started', expect.any(Object));
    });
    ...
    it('should pause game correctly', () => {
      ...
      expect(mockEventBus.emit).toHaveBeenCalledWith('game:paused', expect.any(Object));
    });
    ...
    it('should resume game correctly', () => {
      ...
      expect(game.gameState.isPaused).toBe(false);
      expect(mockEventBus.emit).toHaveBeenCalledWith('game:resumed', expect.any(Object));
    });
    ...
    it('should stop game correctly', () => {
      ...
      expect(game.gameState.isRunning).toBe(false);
      expect(mockEventBus.emit).toHaveBeenCalledWith('game:stopped', expect.any(Object));
    });
  });
  ...
  describe('Game Object Management', () => {
    it('should add game objects correctly', () => {
      ...
      expect(mockEventBus.emit).toHaveBeenCalledWith('game:objectAdded', expect.any(Object));
    });
    ...
    it('should remove game objects correctly', () => {
      ...
      expect(mockEventBus.emit).toHaveBeenCalledWith('game:objectRemoved', expect.any(Object));
    });
  });
