...
describe('Logger', () => {
  ...
  describe('Log Level Management', () => {
    ...
    it('should warn on invalid log level', () => {
      ...
      expect(mockConsole.warn).toHaveBeenCalledWith('Invalid log level: invalid');
    });
  ...
  describe('Function Logging', () => {
    it('should log function execution', () => {
      ...
      const result = logger.function('testFunction', testFunction, 'TestContext');
    ...
    it('should log function errors', () => {
      ...
      expect(mockConsole.error).toHaveBeenCalledWith(
        ...
        expect.objectContaining({ error: 'Test error', duration: expect.any(Number) }),
        'TestContext'
      );
    });
    ...
    it('should log async function execution', async () => {
      ...
      const result = await logger.functionAsync('testAsyncFunction', testFunction, 'TestContext');
