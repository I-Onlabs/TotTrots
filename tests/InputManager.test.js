...
describe('InputManager', () => {
  ...
  describe('Keyboard Input Handling', () => {
    ...
    test('should handle special keys correctly', () => {
      const specialKeys = ['Space', 'Enter', 'Escape', 'Tab', 'ArrowUp', 'ArrowDown'];
  ...
  describe('Mouse Input Handling', () => {
    ...
    test('should handle mouse up events', () => {
      ...
      inputManager.mouse.buttons.set(0, { pressed: true, timestamp: Date.now() });
  ...
  describe('Gamepad Input Handling', () => {
    ...
    test('should update gamepad state', () => {
      ...
      expect(buttonSpy).toHaveBeenCalledWith(expect.objectContaining({
        controller: 0,
        button: 0,
        pressed: true,
        value: 1.0
      ...
      expect(axisSpy).toHaveBeenCalledWith(expect.objectContaining({
        controller: 0,
        axis: 0,
        value: 0.5
      }));
  ...
  describe('Input State Management', () => {
    ...
    test('should check if mouse button is pressed', () => {
      inputManager.mouse.buttons.set(0, { pressed: true, timestamp: Date.now() });
      inputManager.mouse.buttons.set(1, { pressed: false, timestamp: Date.now() });
    ...
    test('should get all gamepads', () => {
      const gamepad1 = { id: 'Gamepad 1', index: 0, connected: true, buttons: new Map(), axes: new Map() };
      const gamepad2 = { id: 'Gamepad 2', index: 1, connected: true, buttons: new Map(), axes: new Map() };
